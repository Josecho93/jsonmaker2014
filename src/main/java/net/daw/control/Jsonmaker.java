...
public class Jsonmaker {
    ...
    public String getForm(int nivel) throws Exception {
        ...
        try {
            ...
            if (nivel == 2) {
                oForm = getForm(oForm);
                oForm = fillInputText(oForm, Aleatorio.randInt(1, 10));
            }
            if (nivel == 3) {
                oForm = getForm(oForm);
                oForm = fillInputText(oForm, Aleatorio.randInt(1, 10));
                oForm = fillInputHidden(oForm, Aleatorio.randInt(1, 10));
            }
            if (nivel == 4) {
                oForm = getForm(oForm);
                oForm = fillInputText(oForm, Aleatorio.randInt(1, 10));
                oForm = fillInputHidden(oForm, Aleatorio.randInt(1, 10));
                oForm = fillInputCheckbox(oForm, Aleatorio.randInt(1, 10));
            }
            if (nivel == 5) {
                oForm = getForm(oForm);
                oForm = fillInputText(oForm, Aleatorio.randInt(1, 10));
                oForm = fillInputHidden(oForm, Aleatorio.randInt(1, 10));
                oForm = fillInputCheckbox(oForm, Aleatorio.randInt(1, 10));
                oForm = fillInputRadio(oForm, Aleatorio.randInt(1, 10));
            }
            if (nivel == 6) {
                oForm = getForm(oForm);
                oForm = fillInputText(oForm, Aleatorio.randInt(1, 10));
                ...
                oForm = fillInputCheckbox(oForm, Aleatorio.randInt(1, 10));
                oForm = fillInputRadio(oForm, Aleatorio.randInt(1, 10));
                oForm = fillInputButton(oForm, Aleatorio.randInt(1, 10));
            }
            if (nivel == 7) {
                oForm = getForm(oForm);
                oForm = fillInputText(oForm, Aleatorio.randInt(1, 10));
                ...
                oForm = fillInputRadio(oForm, Aleatorio.randInt(1, 10));
                oForm = fillInputButton(oForm, Aleatorio.randInt(1, 10));
                oForm = fillSelect(oForm, Aleatorio.randInt(1, 10), Aleatorio.randInt(2, 5));
            }
    ...
    public Form fillSelect(Form oForm, int numControles, int numMaxOpciones) throws Exception {
        try {
            for (int contador1 = 1; contador1 <= numControles; contador1++) {
                ...
                int numSelect = Aleatorio.randInt(1, 99999);
                ...
                int numOpciones = Aleatorio.randInt(2, numMaxOpciones);
                for (int contador2 = 1; contador2 <= numOpciones; contador2++) {
                    int numOption = Aleatorio.randInt(1, 99999);
    ...
    public Form fillInputRadio(Form oForm, int numControles) throws Exception {
        try {
            for (int contador = 1; contador <= numControles; contador++) {
                int numInput = Aleatorio.randInt(1, 99999);
